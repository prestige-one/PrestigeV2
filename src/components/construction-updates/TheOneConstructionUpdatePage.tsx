...
const HERO_IMAGE = "/assets/images/v2/project-featured-images/Front-Exterior-3-scaled.webp";

const THE_ONE_GALLERY: GalleryMonth[] = [
  {
    month: "February 2026",
    images: [
...
export default function TheOneConstructionUpdatePage() {
  const [activeMonth, setActiveMonth] = useState(THE_ONE_GALLERY[0].month);
  const activeGallery = useMemo(
    () => THE_ONE_GALLERY.find((item) => item.month === activeMonth) ?? THE_ONE_GALLERY[0],
    [activeMonth],
  );
      ...
      <main>
        <section className="po-destination-hero po-destination-hero--with-contact-rail po-cu-hero" aria-labelledby="construction-update-title">
          <div
            ...
            role="img"
            aria-label="Construction Update: The One by Prestige One"
          />
          ...
          <div className="po-destination-hero-frame">
            <div className="container po-cu-hero-title-wrap">
              ...
              <h1 id="construction-update-title" className="po-destination-hero-title po-cu-hero-title">
                Construction Update: The One by Prestige One
              </h1>
            </div>
          </div>
