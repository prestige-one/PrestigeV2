    ...
    <>
      ...
      <section className="po-project-page-hero">
        <div className="po-project-page-hero-media">
          <img src={HERO_IMG} alt="Berkeley Square North" />
      ...
      <section className="po-project-page-wide-video" aria-label="Berkeley Square North video">
        <div className="container">
          <video
      ...
      <section id="register-interest" className="po-project-page-register">
        <div className="container">
          ...
          <FinalContactForm defaultProject="Berkeley Square North" />
        </div>
      </section>
